...
var SDMUsersQueryFlag = flag.String("sdm-users-query", "", "define a query according to the SCIM query syntax to filter the SDM users results")
var SDMGroupsQueryFlag = flag.String("sdm-groups-query", "", "define a query according to the SCIM query syntax to filter the SDM groups results")
